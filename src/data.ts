...
export const FARM_LOGS: FarmLog[] = [
  {
    ...
    description:
      "Carefully pruned 200 Dasheri trees to ensure better sunlight penetration for the upcoming harvest. Applied fermented organic compost.",
    image: pruningImg,
    category: "Pruning",
  },
  {
    ...
    description:
      "Random sampling of Langra fruits showed excellent skin health and zero pest infestation. Organic neem oil spray applied as a preventive measure.",
